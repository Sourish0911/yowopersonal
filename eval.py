...
def parse_args():
    ...
    # basic
    parser.add_argument('-tak', '--takenaka', default=True, type=bool,
                        help='takenaka dataset eval')
    ...
    parser.add_argument('--root', default='../tak_data/TAK_IITH_Project/Takenaka_Prop_dataset/',
                        help='data root')
    ...
    parser.add_argument('-v', '--version', default='yowo_v2_nano', type=str,
                        help='build YOWOv2')
    parser.add_argument('--weight', default="./weights_tak2/ucf24/yowo_v2_nano/yowo_v2_nano_epoch_50.pth",
                        type=str, help='Trained state_dict file path to open')
...
if __name__ == '__main__':
    ...
    if args.dataset == 'ucf24':
       num_classes = 24
        # num_classes = 5 ## Added by Akshad 8/04
